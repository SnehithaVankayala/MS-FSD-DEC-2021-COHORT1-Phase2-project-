...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-800">Add Teachers Classes Subjects
			Mapping</h1>
	</div>
	<div class="row">
		<div class="col-lg-12">
			<form class="addTeachersClassesSubjectsMapping"
				action="/LearnersAcademyAdministrativePortal/teacherClassSubjectMapping"
				method="post">
				<div class="form-row">
					<div class="form-group col-md-5">
						<label for="teachersNameCombo">Teacher Name</label> <select
							class="form-control" id="teachersNameCombo"
							name="teachersNameCombo">
				...
				<div class="form-group">
					<button type="reset"
						id="resetFormAddTeachersClassesSubjectsMapping"
						name="resetFormAddTeachersClassesSubjectsMapping"
						class="btn btn-danger">clear</button>
					<button type="submit"
						id="submitFormAddTeachersClassesSubjectsMapping"
						name="submitFormAddTeachersClassesSubjectsMapping"
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		$("#submitFormAddTeachersClassesSubjectsMapping").click(function() {
			...
			document.forms[0].elements["teacherName"].value = $("#teachersNameCombo option:selected").text();
